...
if (function_exists('vc_map_get_attributes')) {						// New VC
	...
	// Add RoseMary color scheme in the row
	if ($scheme && !rosemary_param_is_off($scheme) && !rosemary_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	...
	// Add RoseMary color scheme in the row
	if ($scheme && !rosemary_param_is_off($scheme) && !rosemary_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
