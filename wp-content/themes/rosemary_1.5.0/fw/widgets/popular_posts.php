 ...
 */
add_action( 'widgets_init', 'rosemary_widget_popular_posts_load' );

/**
 * Register our widget.
 */
function rosemary_widget_popular_posts_load() {
	register_widget('rosemary_widget_popular_posts');
}

/**
 * Most popular and commented Widget class.
 */
class rosemary_widget_popular_posts extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_popular_posts', 'description' => esc_html__('The most popular and most commented blog posts (extended)', 'rosemary'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'rosemary_widget_popular_posts');

		/* Create the widget. */
		parent::__construct( 'rosemary_widget_popular_posts', esc_html__('RoseMary - Most Popular & Commented Posts', 'rosemary'), $widget_ops, $control_ops );
	}
	...
	function widget($args, $instance) {
		...
		$show_counters = isset($instance['show_counters']) && $instance['show_counters'] > 0 ? rosemary_get_theme_option('blog_counters') : '';
		...
		if (count($tabs) > 0) {
			...
			echo trim(rosemary_do_shortcode('[trx_tabs style="2"]'.join($tabs).'[/trx_tabs]'));
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_popular')); ?>"><?php esc_html_e('Most popular tab title:', 'rosemary'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_commented')); ?>"><?php esc_html_e('Most commented tab title:', 'rosemary'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_liked')); ?>"><?php esc_html_e('Most liked tab title:', 'rosemary'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_1"><?php esc_html_e('Show', 'rosemary'); ?></label>
