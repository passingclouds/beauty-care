 ...
 */
add_action( 'widgets_init', 'rosemary_widget_recent_reviews_load' );

/**
 * Register our widget.
 */
function rosemary_widget_recent_reviews_load() {
	register_widget('rosemary_widget_recent_reviews');
}

/**
 * recent_reviews Widget class.
 */
class rosemary_widget_recent_reviews extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_recent_reviews', 'description' => esc_html__('Recent reviews', 'rosemary'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'rosemary_widget_recent_reviews');

		/* Create the widget. */
		parent::__construct( 'rosemary_widget_recent_reviews', esc_html__('RoseMary - Recent reviews', 'rosemary'), $widget_ops, $control_ops );
	...
	function widget($args, $instance) {
		...
		$post_rating = 'reviews_avg'.(rosemary_get_theme_option('reviews_first')=='author' ? '' : '2');
