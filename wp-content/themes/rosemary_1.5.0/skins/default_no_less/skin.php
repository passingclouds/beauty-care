...
if ( !function_exists( 'rosemary_options_settings_theme_setup' ) ) {
	add_action( 'rosemary_action_before_init_theme', 'rosemary_options_settings_theme_setup3', 3 );	// Priority 1 for add rosemary_filter handlers, 2 for create Theme Options
	function rosemary_options_settings_theme_setup3() {
		global $ROSEMARY_GLOBALS;
		$ROSEMARY_GLOBALS['options']['top_panel_scheme']['options']		= $ROSEMARY_GLOBALS['options_params']['list_bg_tints'];
		$ROSEMARY_GLOBALS['options']['sidebar_main_scheme']['options']	= $ROSEMARY_GLOBALS['options_params']['list_bg_tints'];
		$ROSEMARY_GLOBALS['options']['sidebar_outer_scheme']['options']	= $ROSEMARY_GLOBALS['options_params']['list_bg_tints'];
		$ROSEMARY_GLOBALS['options']['sidebar_footer_scheme']['options']= $ROSEMARY_GLOBALS['options_params']['list_bg_tints'];
		$ROSEMARY_GLOBALS['options']['testimonials_scheme']['options']	= $ROSEMARY_GLOBALS['options_params']['list_bg_tints'];
		$ROSEMARY_GLOBALS['options']['twitter_scheme']['options']		= $ROSEMARY_GLOBALS['options_params']['list_bg_tints'];
		$ROSEMARY_GLOBALS['options']['contacts_scheme']['options']		= $ROSEMARY_GLOBALS['options_params']['list_bg_tints'];
		$ROSEMARY_GLOBALS['options']['copyright_scheme']['options']		= $ROSEMARY_GLOBALS['options_params']['list_bg_tints'];
	}
}
...
if (!function_exists('rosemary_action_skin_theme_setup')) {
	...
	function rosemary_action_skin_theme_setup() {
		...
		rosemary_set_theme_setting('less_compiler', 'no');
		// Disable customizer demo
		rosemary_set_theme_setting('customizer_demo', false);
...
//			'accent3_hover'			=> '',
		...
		rosemary_add_color_scheme('contrast', array(

			'title'		 =>	esc_html__('Contrast', 'rosemary'),
...
//			'accent3_hover'			=> '',
		...
		rosemary_add_color_scheme('modern', array(

			'title'		 =>	esc_html__('Modern', 'rosemary'),
...
//			'accent3_hover'			=> '',
		...
		rosemary_add_color_scheme('pastel', array(

			'title'		 =>	esc_html__('Pastel', 'rosemary'),
...
if (!function_exists('rosemary_filter_skin_add_styles_inline')) {
	...
	function rosemary_filter_skin_add_styles_inline($custom_style) {
		...
		//			';
		//		}
		$clr = rosemary_get_scheme_colors();
		$clr['accent1_rgb'] = rosemary_hex2rgb($clr['accent1']);
		$clr['accent1_hover_rgb'] = rosemary_hex2rgb($clr['accent1_hover']);
		$fnt = rosemary_get_custom_fonts_properties();
		$css = '

body {
	'.rosemary_get_custom_font_css('p').';
}

h1 { '.rosemary_get_custom_font_css('h1').'; '.rosemary_get_custom_margins_css('h1').'; }
h2 { '.rosemary_get_custom_font_css('h2').'; '.rosemary_get_custom_margins_css('h2').'; }
h3 { '.rosemary_get_custom_font_css('h3').'; '.rosemary_get_custom_margins_css('h3').'; }
h4 { '.rosemary_get_custom_font_css('h4').'; '.rosemary_get_custom_margins_css('h4').'; }
h5 { '.rosemary_get_custom_font_css('h5').'; '.rosemary_get_custom_margins_css('h5').'; }
h6 { '.rosemary_get_custom_font_css('h6').'; '.rosemary_get_custom_margins_css('h6').'; }
a,
.scheme_dark a,
.scheme_light a {
	'.rosemary_get_custom_font_css('link').';
	color: '.$clr['accent1'].';
}
a:hover,
.scheme_dark a:hover,
...
select,
textarea {
	'.rosemary_get_custom_font_css('input').';
}
...
.top_panel_middle .logo {
	'.rosemary_get_custom_margins_css('logo').';
}
.logo .logo_text {
	'.rosemary_get_custom_font_css('logo').';
}
...
.menu_main_nav > li > a {
	...
	'.rosemary_get_custom_font_css('menu').';
}
...
.menu_main_nav > li ul {
	'.rosemary_get_custom_font_css('submenu').';
}
.menu_main_nav > li > ul {
...
.post_info {
	'.rosemary_get_custom_font_css('info').';
	'.rosemary_get_custom_margins_css('info').';
}
...
button,
.sc_button {
	'.rosemary_get_custom_font_css('button').';
}
input[type="submit"],
input[type="reset"],
input[type="button"],
