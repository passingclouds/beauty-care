...
if ( !function_exists( 'rosemary_template_single_standard_theme_setup' ) ) {
	add_action( 'rosemary_action_before_init_theme', 'rosemary_template_single_standard_theme_setup', 1 );
	function rosemary_template_single_standard_theme_setup() {
		rosemary_add_template(array(
			'layout' => 'single-standard',
			'mode'   => 'single',
			'need_content' => true,
			'need_terms' => true,
			'title'  => esc_html__('Single standard', 'rosemary'),
			'thumb_title'  => esc_html__('Fullwidth image', 'rosemary'),
			'w'		 => 1170,
			'h'		 => 660
		));
	}
...
// Template output
if ( !function_exists( 'rosemary_template_single_standard_output' ) ) {
	function rosemary_template_single_standard_output($post_options, $post_data) {
		...
		if (!$sidebar_present) rosemary_close_wrapper();	// .post_item
