...
if ( !function_exists( 'rosemary_template_portfolio_theme_setup' ) ) {
	add_action( 'rosemary_action_before_init_theme', 'rosemary_template_portfolio_theme_setup', 1 );
	function rosemary_template_portfolio_theme_setup() {
		rosemary_add_template(array(
			'layout' => 'portfolio_2',
			'template' => 'portfolio',
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile (with hovers, different height) /2 columns/', 'rosemary'),
		...
		rosemary_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile /3 columns/', 'rosemary'),
		...
		rosemary_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile /4 columns/', 'rosemary'),
		...
		rosemary_add_template(array(
			...
			'title'  => esc_html__('Grid tile (with hovers, equal height) /2 columns/', 'rosemary'),
		...
		rosemary_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Grid tile /3 columns/', 'rosemary'),
		...
		rosemary_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Grid tile /4 columns/', 'rosemary'),
		...
		rosemary_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile (with hovers, width=height) /2 columns/', 'rosemary'),
			'thumb_title'  => esc_html__('Large square image (crop)', 'rosemary'),
			'w'		 => 870,
			'h' 	 => 870
		));
		rosemary_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile /3 columns/', 'rosemary'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'rosemary'),
			'w'		 => 390,
			'h'		 => 390
		));
		rosemary_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile /4 columns/', 'rosemary'),
		...
		rosemary_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored excerpt', 'rosemary'),
			'thumb_title'  => esc_html__('Small square image (crop)', 'rosemary'),
			'w'		 => 300,
			'h'		 => 300
		));
		rosemary_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile (with hovers, width=height) /2 columns/', 'rosemary'),
			'thumb_title'  => esc_html__('Large square image (crop)', 'rosemary'),
			'w'		 => 870,
			'h' 	 => 870
		));
		rosemary_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile /3 columns/', 'rosemary'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'rosemary'),
			'w'		 => 390,
			'h'		 => 390
		));
		rosemary_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile /4 columns/', 'rosemary'),
			'thumb_title'  => esc_html__('Small square image (crop)', 'rosemary'),
			'w'		 => 300,
			'h'		 => 300
		));
		rosemary_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /2 columns/', 'rosemary'),
			'thumb_title'  => esc_html__('Large square image (crop)', 'rosemary'),
			'w'		 => 870,
			'h' 	 => 870
		));
		rosemary_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /3 columns/', 'rosemary'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'rosemary'),
			'w'		 => 390,
			'h'		 => 390
		));
		rosemary_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /4 columns/', 'rosemary'),
			'thumb_title'  => esc_html__('Small square image (crop)', 'rosemary'),
			'w'		 => 300,
			'h'		 => 300
		));
		rosemary_add_template(array(
			...
			'title'  => esc_html__('Alternative grid (with hovers) /2 columns/', 'rosemary'),
			'thumb_title'  => esc_html__('Large square image (crop)', 'rosemary'),
			'w'		 => 870,
			'h' 	 => 870
		));
		rosemary_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'small_margins',
			'title'  => esc_html__('Alternative grid /3 columns/', 'rosemary'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'rosemary'),
			'w'		 => 390,
			'h'		 => 390
		));
		rosemary_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'small_margins',
			'title'  => esc_html__('Alternative grid /4 columns/', 'rosemary'),
			'thumb_title'  => esc_html__('Small square image (crop)', 'rosemary'),
			'w'		 => 300,
			'h'		 => 300
		));
		// Add template specific scripts
		add_action('rosemary_action_blog_scripts', 'rosemary_template_portfolio_add_scripts');
	}
}

// Add template specific scripts
if (!function_exists('rosemary_template_portfolio_add_scripts')) {
	//add_action('rosemary_action_blog_scripts', 'rosemary_template_portfolio_add_scripts');
	function rosemary_template_portfolio_add_scripts($style) {
		if (rosemary_substr($style, 0, 10) == 'portfolio_'
			|| rosemary_substr($style, 0, 5) == 'grid_'
			|| rosemary_substr($style, 0, 7) == 'square_'
			|| rosemary_substr($style, 0, 6) == 'short_'
			|| rosemary_substr($style, 0, 6) == 'alter_'
			|| rosemary_substr($style, 0, 8) == 'colored_') {
...
// Template output
if ( !function_exists( 'rosemary_template_portfolio_output' ) ) {
	function rosemary_template_portfolio_output($post_options, $post_data) {
		...
		if ($style == 'colored' && $columns==1) {				// colored excerpt style (1 column)
					...
					<div class="post_content isotope_item_content">
						<div class="post_featured img">
							...
							if ($post_data['post_video'] || $post_data['post_audio'] || $post_data['post_thumb'] ||  $post_data['post_gallery']) {
								require rosemary_get_file_dir('templates/_parts/post-featured.php');
							}
							*/
							...
							$new = rosemary_get_custom_option('mark_as_new', '', $post_data['post_id'], $post_data['post_type']);					// !!!!!! Get option from specified post
							if ($new && $new > date('Y-m-d')) {
								?><div class="post_mark_new"><?php esc_html_e('NEW', 'rosemary'); ?></div><?php
							}
							?>
						</div>
						...
						<div class="post_content clearfix">
							...
							<?php if ($post_data['post_link'] != '') { ?>
								<div class="post_buttons">
									<?php echo trim(rosemary_sc_button(array('size'=>'small', 'link'=>$post_data['post_link']), esc_html__('LEARN MORE', 'rosemary'))); ?>
								</div>
							<?php } ?>
						</div>
					</div>				<!-- /.post_content -->
			...
			if ($style=='alter') {
				...
				$alter_size = explode('_', rosemary_get_custom_option('alter_thumb_size', '1_1', $post_data['post_id'], $post_data['post_type']));	// !!!!!! Get option from specified post
				$alter_size[0] = max(1, $alter_size[0]);
				$alter_size[1] = max(1, empty($alter_size[1]) ? 1 : $alter_size[1]);
				$post_data['post_thumb'] = rosemary_get_resized_image_tag($post_data['post_attachment'],
								...
								if ($post_data['post_protected']) {
									...
									if ($post_data['post_excerpt']) {
										echo in_array($post_data['post_format'], array('quote', 'link', 'chat', 'aside', 'status')) 
											...
											: '<p>' . ($link_start) 
												. (rosemary_strpos($post_options['hover'], 'square')!==false
													? strip_tags($post_data['post_excerpt'])
													: trim(rosemary_strshort($post_data['post_excerpt'], isset($post_options['descr']) ? $post_options['descr'] : rosemary_get_custom_option('post_excerpt_maxlength_masonry')))
													)
												. ($link_end) . '</p>';
									}
									if ($post_data['post_link'] != '') {
										...
										if ($style=='colored_1') {
											...
											echo trim(rosemary_sc_button(array('size'=>'small', 'link'=>$post_data['post_link']), esc_html__('Learn more', 'rosemary')));
											?></span><?php
										} else if (!rosemary_param_is_off($post_options['readmore']) && !in_array($post_data['post_format'], array('quote', 'link', 'chat', 'aside', 'status'))) {
