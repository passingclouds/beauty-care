...
if ( !function_exists( 'rosemary_template_testimonials_3_theme_setup' ) ) {
	add_action( 'rosemary_action_before_init_theme', 'rosemary_template_testimonials_3_theme_setup', 1 );
	function rosemary_template_testimonials_3_theme_setup() {
		rosemary_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 3/', 'rosemary'),
			'thumb_title'  => esc_html__('Avatar (small)', 'rosemary'),
			'w'		 => 75,
			'h'		 => 75
		));
	}
...
// Template output
if ( !function_exists( 'rosemary_template_testimonials_3_output' ) ) {
	function rosemary_template_testimonials_3_output($post_options, $post_data) {
		$show_title = true;
