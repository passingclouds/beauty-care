...
if ( !function_exists( 'rosemary_template_testimonials_4_theme_setup' ) ) {
	add_action( 'rosemary_action_before_init_theme', 'rosemary_template_testimonials_4_theme_setup', 1 );
	function rosemary_template_testimonials_4_theme_setup() {
		rosemary_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 4/', 'rosemary'),
...
// Template output
if ( !function_exists( 'rosemary_template_testimonials_4_output' ) ) {
	function rosemary_template_testimonials_4_output($post_options, $post_data) {
		$show_title = true;
