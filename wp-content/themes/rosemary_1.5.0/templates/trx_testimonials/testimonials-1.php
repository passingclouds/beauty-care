...
if ( !function_exists( 'rosemary_template_testimonials_1_theme_setup' ) ) {
	add_action( 'rosemary_action_before_init_theme', 'rosemary_template_testimonials_1_theme_setup', 1 );
	function rosemary_template_testimonials_1_theme_setup() {
		rosemary_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 1/', 'rosemary'),
...
// Template output
if ( !function_exists( 'rosemary_template_testimonials_1_output' ) ) {
	function rosemary_template_testimonials_1_output($post_options, $post_data) {
		$show_title = true;
