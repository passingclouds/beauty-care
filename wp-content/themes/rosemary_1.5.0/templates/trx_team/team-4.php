...
if ( !function_exists( 'rosemary_template_team_4_theme_setup' ) ) {
	add_action( 'rosemary_action_before_init_theme', 'rosemary_template_team_4_theme_setup', 1 );
	function rosemary_template_team_4_theme_setup() {
		rosemary_add_template(array(
			'layout' => 'team-4',
			'template' => 'team-4',
			'mode'   => 'team',
			/*'container_classes' => 'sc_slider_nopagination sc_slider_controls sc_slider_controls_side',*/
			'title'  => esc_html__('Team /Style 4/', 'rosemary'),
...
// Template output
if ( !function_exists( 'rosemary_template_team_4_output' ) ) {
	function rosemary_template_team_4_output($post_options, $post_data) {
		$show_title = true;
